package com.shawn.study.java.web.jpa;
...
/**
 * delegating {@code EntityManager} is implemented using JNDI technology
 *
 * @author Shawn
 * @since 1.0.0
 */
public class DelegatingEntityManager implements EntityManager {
  ...
  /**
   * Tomcat JNDI can be injected properties by invoke setter method
   *
