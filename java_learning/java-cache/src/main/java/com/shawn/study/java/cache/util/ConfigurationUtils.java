...
import com.shawn.study.java.cache.configuration.ImmutableCompleteConfiguration;
...
public class ConfigurationUtils {
   ...
   */
  public static <K, V> MutableConfiguration<K, V> mutableConfiguration(
   ...
   */
  public static <K, V> CompleteConfiguration<K, V> immutableConfiguration(
      Configuration<K, V> configuration) {
  ...
  public static <K, V> CacheEntryListenerConfiguration<K, V> cacheEntryListenerConfiguration(
    ...
    return new MutableCacheEntryListenerConfiguration<>(
        () -> listener, () -> filter, isOldValueRequired, isSynchronous);
  }
}
