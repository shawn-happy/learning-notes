...
public class WindowAggregationDemo {
  ...
  public static class AvgPv
      implements AggregateFunction<Event, Tuple2<HashSet<String>, Long>, Double> {
    @Override
    ...
    @Override
    public Tuple2<HashSet<String>, Long> add(
        Event value, Tuple2<HashSet<String>, Long> accumulator) {
