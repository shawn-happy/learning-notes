...
public class LoginFailDetectProExample {
  public static void main(String[] args) throws Exception {
    ...
    KeyedStream<LoginEvent, String> stream =
        env.fromElements(
    ...
    Pattern<LoginEvent, LoginEvent> pattern =
        Pattern.<LoginEvent>begin("fail") // 第一个登录失败事件
            .where(
