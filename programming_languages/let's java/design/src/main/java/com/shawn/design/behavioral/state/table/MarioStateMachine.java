package com.shawn.design.behavioral.state.table;

import com.shawn.design.behavioral.state.StateEnum;
import static com.shawn.design.behavioral.state.table.Event.*;
import static com.shawn.design.behavioral.state.StateEnum.*;
...
public class MarioStateMachine {
  ...
  public void obtainCape() {
    executeEvent(GET_CAPE);
  }

  public void obtainFireFlower() {
    executeEvent(GET_FIRE);
  }
