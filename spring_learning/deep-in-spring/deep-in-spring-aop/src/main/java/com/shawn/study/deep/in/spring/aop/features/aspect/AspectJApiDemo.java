...
import com.shawn.study.deep.in.spring.aop.features.config.AspectJApiConfiguration;
        ...
        new MethodBeforeAdvice() {
          ...
          public void before(Method method, Object[] args, Object target) throws Throwable {
            if ("put".equals(method.getName()) && args.length == 2) {
              ...
              System.out.printf(
                  "[MethodBeforeAdvice] 当前存放是 Key: %s , Value : %s ，" + "代理对象：%s\n",
                  args[0], args[1], proxy);
            }
          }
        });
    ...
    proxyFactory.addAdvice(
        new AfterReturningAdvice() {
          ...
          public void afterReturning(
            ...
            if ("put".equals(method.getName()) && args.length == 2) {
              System.out.printf(
                  "[AfterReturningAdvice] 当前存放是 Key: %s , 新存放的 Value : %s , 之前关联的 Value : %s\n ",
                  args[0], // key
                  args[1], // new value
